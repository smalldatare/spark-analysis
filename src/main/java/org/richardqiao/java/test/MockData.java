...
import org.richardqiao.java.util.StringUtils;
...
public class MockData {
   ...
   * @param sqlContext
   */
  public static void mock(JavaSparkContext sc, SQLContext sqlContext, boolean saveToFile) {
    ...
    if (saveToFile)
      // rowsRDD.saveAsTextFile("/Users/lqiao/code/spark-analysis/src/main/resources/testdata/user_visit_action");
      df.write().format("json").save("/Users/lqiao/code/spark-analysis/src/main/resources/testdata/user_visit_action");
    ...
    if (saveToFile)
      df2.write().format("json").save("/Users/lqiao/code/spark-analysis/src/main/resources/testdata/user_info");
    ...
    if (saveToFile)
      df3.write().format("json").save("/Users/lqiao/code/spark-analysis/src/main/resources/testdata/product_info");
